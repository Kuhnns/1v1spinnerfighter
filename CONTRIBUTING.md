...
6. Exercise the damage matrix boundaries, tied-stat Power Clash, four- and six-tier Speed Blitz thresholds, Boundless immunity, the exact five-second Boundless cue timeline, local-track fallback and cleanup, Last Stand presentation, and a full winner-stays-on battle whenever combat or presentation logic changes.
